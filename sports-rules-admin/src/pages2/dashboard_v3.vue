          ...
          <q-card flat bordered class="shadow theme_color q-pa-none q-ma-none">
            <q-card-section class="row">
              <div class="text-white col-12" style="font-weight: 600;letter-spacing: 1px;font-size: 16px;">Sales vs
                Goals
                <q-btn flat dense icon="fas fa-download" class="float-right" @click="SaveImage('sales_goals')" color="grey-6">
          ...
          <q-card flat bordered class="shadow theme_color q-pa-none q-ma-none">
            <q-card-section class="row">
              <div class="text-white col-12" style="font-weight: 600;letter-spacing: 1px;font-size: 16px;">Market Share
                & Growth
                <q-btn flat dense icon="fas fa-download" class="float-right" @click="SaveImage('market_share')" color="grey-6">
                  <q-tooltip>Download</q-tooltip>
                </q-btn>
              </div>
            </q-card-section>
          ...
          <q-card flat bordered class="shadow theme_color q-pa-none q-ma-none">
            <q-card-section>
              <div class="text-white" style="font-weight: 600;letter-spacing: 1px;font-size: 16px;">Key Competitors
                <q-btn flat dense icon="fas fa-download" class="float-right" @click="SaveImage('key_competitors')" color="grey-6">
                  <q-tooltip>Download</q-tooltip>
                </q-btn>
              </div>
            </q-card-section>
          ...
          <q-card flat bordered class="shadow theme_color q-pa-none q-ma-none">
            <q-card-section>
              <div class="text-white" style="font-weight: 600;letter-spacing: 1px;font-size: 16px;">Sales Pipeline by
                Sales Rep
                <q-btn flat dense icon="fas fa-download" class="float-right" @click="SaveImage('sales_pipeline')" color="grey-6">
                  <q-tooltip>Download</q-tooltip>
                </q-btn>
              </div>
            </q-card-section>
      ...
      <div class="row q-col-gutter-md q-pt-md">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <q-card flat bordered class="shadow theme_color">
            <q-table card-style="background-color: #343a40 !important;color:white" card-container-style="background-color: #343a40 !important" title="All Activities" :data="data" :hide-header="mode === 'grid'" table-class="text-white" table-header-class="text-white" :columns="columns" row-key="name" :grid="mode=='grid'" :filter="filter" :pagination.sync="pagination">
              ...
              <template v-slot:top-right="props">
                ...
                <q-btn flat round dense :icon="props.inFullscreen ? 'fullscreen_exit' : 'fullscreen'" @click="props.toggleFullscreen" v-if="mode === 'list'" class="text-white">
                  <q-tooltip :disable="$q.platform.is.mobile" v-close-popup>{{props.inFullscreen ? 'Exit Fullscreen' : 'Toggle Fullscreen'}}
                  </q-tooltip>
                </q-btn>

                <q-btn flat round dense :icon="mode === 'grid' ? 'list' : 'grid_on'" @click="mode = mode === 'grid' ? 'list' : 'grid'; separator = mode === 'grid' ? 'none' : 'horizontal'" v-if="!props.inFullscreen" class="text-white">
