<template>
  <q-page class="q-pa-sm">
    <q-card>
      <q-table title="Employee Salary List" :data="data" :hide-header="mode === 'grid'" :columns="columns" row-key="name" :grid="mode=='grid'" :filter="filter" :pagination.sync="pagination">
