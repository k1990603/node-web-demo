        ...
        <q-card class="login-form" v-bind:style="
          ...
          <q-card-section>
            <q-form class="q-gutter-md">
              ...
              <div>
                <q-btn label="Login" to="/dashboard" type="button" color="primary" @click="loginNotify" />

                <a style="font-size: 30px;" class="float-right" href="https://github.com/sponsors/mayank091193" target="_blank" title="Donate"><i class="fas fa-heart" style="color: #eb5daa"></i></a>
              </div>
            </q-form>
          </q-card-section>
        </q-card>
